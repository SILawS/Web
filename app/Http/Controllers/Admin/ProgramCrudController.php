...
class ProgramCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->addFields([
            ...
            [
                'name' => 'tenure_stop',
                'label' => 'When to stop advertising',
                'type' => 'datetime_picker',
            ],            
            [
                'name' => 'duration_start',
                'label' => 'When the program starts',
                'type' => 'datetime_picker',
            ],            
            [
                'name' => 'duration_stop',
                'label' => 'When the program stops',
                'type' => 'datetime_picker',
            ],
            [
                'name' => 'image',
    ...
    {
        if(Program::find($id)->post)
            return Markdown::parse(Program::find($id)->post->body);
        else
